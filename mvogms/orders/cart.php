...
<div class="content py-3">
            ...
            <div id="cart-list">
                ...
                ?>
                    <div class="col-12 border">
                        <span>Nhà cung cấp: <b><?= $vrow['code']. " - " . $vrow['shop_name'] ?></b></span>
                    </div>
                ...
                <?php endwhile; ?>
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 h4 font-weight-bold text-right text-muted">Tổng cộng</div>
    ...
    <div class="text-right">
        <a href="./?page=orders/checkout" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-money-bill-wave"></i> Thanh toán</a>
    </div>
</div>
<script>
    $(function(){
