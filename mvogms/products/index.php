                ...
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="row" id="product_list">
                            ...
                            $products = $conn->query("SELECT p.*, v.shop_name as vendor, c.name as `category` FROM `product_list` p inner join vendor_list v on p.vendor_id = v.id inner join category_list c on p.category_id = c.id where v.delete_flag=0 and p.delete_flag = 0 and p.`status` =0 {$swhere} order by RAND()");
