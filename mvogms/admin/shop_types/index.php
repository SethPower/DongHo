...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Danh sách các đơn vị nhà cung cấp</h3>
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Thêm Danh mục cửa hàng mới',"shop_types/manage_shop_type.php")
		})
		$('.edit_data').click(function(){
			uni_modal('Cập nhật danh mục cửa hàng',"shop_types/manage_shop_type.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xóa?","delete_shop_type",[$(this).attr('data-id')])
		})
