...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-primary shadow">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="shop_name" class="control-label">Tên nhà cung cấp</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_owner" class="control-label">Họ tên chủ sở hữu</label>
					...
					<div class="row">
						...
						<small class="text-muted">Để trống nếu bạn không muốn cập nhật.</small>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-user">Câp nhật</button>
				</div>
			</div>
		</div>
	</div>
