                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Phí được nhận</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-right align-middle px-2 py-1"><?php echo format_num($row['total_amount']) ?></td>
                                     <td class="text-right align-middle px-2 py-1"><?php echo format_num($row['total_amount']*0.05) ?></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-right px-1 py-1 align-middel"><?= format_num($total) ?></th>
                                 <th class="text-right px-1 py-1 align-middel"><?= format_num($total*0.05) ?></th>
                            </tr>
                        </tfoot>
                    </table>
                    </div>
