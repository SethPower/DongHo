                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Giá trị đơn hàng</th>
                                <th class="text-center align-middle py-1">Chiết khấu</th>
                                <th class="text-center align-middle py-1">Phí thanh toán</th>
                                <th class="text-center align-middle py-1">Doanh thu</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-right align-middle px-2 py-1">5%</td>
                                    <td class="text-right align-middle px-2 py-1"><?php echo format_num($row['tru']=$row['total_amount']*0.05) ?></td>
                                     </td>
                                    <td class="text-right align-middle px-2 py-1"><?php echo format_num($row['total_amount']-$row['tru']) ?></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-right px-1 py-1 align-middel"><?= format_num($total) ?></th>
                                 ...
                                 <th class="text-right px-1 py-1 align-middel"></th>
                                 <th class="text-right px-1 py-1 align-middel"><?= format_num($trutong=$total*0.05) ?></th>
                                  <th class="text-right px-1 py-1 align-middel"><?= format_num($total-$trutong) ?></th>
                            </tr>
                        </tfoot>
                    </table>
                    </div>
