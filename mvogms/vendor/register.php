        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <a href="./register.php" class="h1"><b>Đăng ký</b></a>
                    </div>
                    <div class="card-body">
                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">Họ tên chủ cửa hàng</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">Danh mục cửa hàng</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="cpassword" class="control-label">Xác nhận lại mật khẩu</label>
                                <div class="input-group input-group-sm">
                        ...
                        <div class="row align-item-end">
                            <div class="col-8">
                                <a href="<?= base_url ?>">Quay lại trang web</a>
                            </div>
                            <!-- /.col -->
                            <div class="col-4">
                            ...
                            <a href="<?= base_url.'vendor/login.php' ?>">Đã có tài khoản?</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
