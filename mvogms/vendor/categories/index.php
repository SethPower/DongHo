...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Thêm danh mục sản phẩm mới',"categories/manage_category.php")
		})
		...
		$('.delete_data').click(function(){
			_conf("Bạn thực sự muốn xóa danh mục này vĩnh viễn?","delete_category",[$(this).attr('data-id')])
		})
