			...
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="shop_owner" class="control-label">Tên đầy đủ nhà cung cấp</label>
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="cpassword" class="control-label">Xác nhận mật khẩu mởi</label>
							<div class="input-group input-group-sm">
						...
						<small class="text-muted">Để trống trường mật khẩu nếu không muốn cập nhật mật khẩu</small>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
